...
func (b *Binarizer) Compute(k *kernel.Kernel) error {
	...
	case tensor.Int32:
		binarize(input.Int32Data, output.Int32Data, b.threshold)
	case tensor.Int64:
		binarize(input.Int64Data, output.Int64Data, b.threshold)
	default:
		return fmt.Errorf("Binarizer supports float32, float64, int32 and int64 tensors, got: %s", input.DType)
	}
	return nil
}
